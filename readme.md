...
> 🔵 **对齐待办**：本项目当前的 `sys-remote + WireGuard 网关 + 自定义 qrexec 服务` 方案，是在官方 RemoteVM 落地**之前**的自造设计。方向一致（都走 qrexec），但**尚未对齐 R4.3 的 RemoteVM 原语**。这是后续设计需要重点调研并对齐的地方。
...
- [ ] **调研并对齐 Qubes OS R4.3 的 RemoteVM 机制**（决定拥抱官方原语还是明确记录差异）
