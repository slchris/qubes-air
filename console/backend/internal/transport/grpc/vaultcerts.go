...
const getCredentialService = "qubesair.GetCredential" // #nosec G101 -- a qrexec service name, not a credential //nolint:gosec // G101: a qrexec service name, not a credential
